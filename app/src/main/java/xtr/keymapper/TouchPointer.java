...
public class TouchPointer extends Service {
    ...
    private void connectRemoteService(KeymapProfile profile) {
        ...
        RemoteServiceHelper.getInstance(this, service -> {
            ...
            Display display = displayManager.getDisplay(InputService.displayId);
            ...
            mHandler.post(() -> {
                if(cursorView == null) {
                    ...
                    cursorView = CursorBinding.inflate(LayoutInflater.from(
                            new ContextThemeWrapper(TouchPointer.this.createDisplayContext(display), R.style.Theme_XtMapper)
                    )).getRoot();
